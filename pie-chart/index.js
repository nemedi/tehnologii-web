HTMLElement.prototype.pieChart = function(data,  options) {
	...
	options.colors = options.colors
		? options.colors
		: ['#52D726', '#FFEC00', '#FF7300', '#FF0000', '#007ED6', '#7CDDDD'];
	options.precision = options.precision ? options.precision : 2;
	...
	html = options.title ? `<tr><td colspan="3"><b>${options.title}</b></tr>` : '';
